...
<!--             <a href="#">
                <span class="glyphicon glyphicon-book"></span>Add Class<span data-toggle="collapse" href="#sub-item-3" class="icon pull-right"><em class="glyphicon glyphicon-s glyphicon-plus"></em></span>
              </a>
            <ul class="children collapse" id="sub-item-3">
                <li>
                    <a  href="<?= site_url()?>courses/course_add">
                        <span class="glyphicon glyphicon-share-alt"></span> Add Class
                    </a>
                </li>
                <li>
        ...
        <li>
            <a href="<?= site_url()?>courses/course_add">
                <span class="glyphicon glyphicon-file"></span> Add Class
            </a>
        </li>
        <li>
